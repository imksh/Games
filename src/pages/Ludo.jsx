...
import { makeSnakeBoard } from "../utils/makeSnakeBoard";
...
const Ludo = () => {
  ...
  return (
    <div className="container min-h-screen min-w-screen flex flex-col justify-center items-center gradient1">
      <div className="nav py-4 px-10 bg-blue-800 fixed top-0 w-full text-white flex justify-between items-center">
      ...
      <div className="flex min-w-screen justify-center items-center mt-15">
        {winner && (
          <div className="absolute bg-green-600 text-white w-[50vw] h-[50vh] z-10 rounded-2xl flex justify-center gap-8 items-center flex-col z-50">
        ...
        <div className="player1 flex-1 flex justify-center items-center">
          ...
          {cells.map((n) => (
            <>
              <img
                ...
                alt="ladder"
                className="absolute z-20 w-30 top-23"
              />
              <img
                src="/images/ludo/ladder.png"
                alt="ladder"
                className="absolute z-20 w-30 h-48 top-77 left-58"
              />
              <img
                src="/images/ludo/ladder.png"
                alt="ladder"
                className="absolute z-20 w-30 h-75 top-35 left-82 rotate-x-180 rotate-180"
              />

              <img
                src="/images/ludo/ladder.png"
                alt="ladder"
                className="absolute z-20 w-30 h-45 top-10 right-0"
              />

              <img
                src="/images/ludo/ladder.png"
                alt="ladder"
                className="absolute z-20 w-33 h-40 top-59 left-18 rotate-x-180 rotate-180 rotate-z-12"
              />

              <img
                src="/images/ludo/snake.png"
                alt="snake"
                className="absolute z-30 w-30 top-8 left-17"
              />

              <img
                src="/images/ludo/snake.png"
                alt="snake"
                className="absolute z-30 h-35 top-48 left-20"
              />

              <div
                key={n}
                className="w-14 h-14 border border-black relative flex justify-center items-center gap-2"
              >
                <div
                  className={`z-40 absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] ${
